...
# Newton-Raphson Method for double
...
# Bisection Method for interval 1
...
# Newton-Raphson Method for different initial guess
...
# Bisection Method for double with a different interval
